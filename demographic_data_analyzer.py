...
def calculate_demographic_data(print_data=True):
    # Read data from file (assuming the dataset is named 'adult.csv' or another relevant dataset)
    df = pd.read_csv('adult.csv')  # Replace with the correct file path
    ...
    highest_earning_country_percentage = country_earnings[('>50K',)].max() * 100
